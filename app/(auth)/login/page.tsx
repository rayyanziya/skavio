...
function LoginForm() {
  ...
  return (
    <div className="border border-border bg-surface p-8">
      <h1 className="text-lg font-bold text-body mb-1">Sign in</h1>
      <p className="text-sm text-muted mb-6">Welcome back to Skavio</p>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="border border-border bg-surface p-8 text-center text-sm text-muted">Loading…</div>}>
      <LoginForm />
    </Suspense>
  );
}
